...
func (s *Server) handleOpenAPI(w http.ResponseWriter, _ *http.Request) {
	...
	writeJSON(w, http.StatusOK, map[string]any{
		...
		"paths": map[string]any{
			...
			"/.well-known/capability-graph.json":           map[string]any{"get": map[string]any{"summary": "Machine-readable graph of ChainFX capabilities, dependencies and execution plans"}},
			...
			"/agent/v1/capability-graph":                   map[string]any{"get": map[string]any{"summary": "Capability graph for autonomous planning"}},
